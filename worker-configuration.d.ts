/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ce29b94e6eb140c7eb97dd9689fb9a8e)
// Runtime types generated with workerd@1.20251210.0 2025-10-11 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import('./worker/index');
		durableNamespaces: 'Do';
	}
	interface Env {
		PRODUCTION: string;
		DO: DurableObjectNamespace<import('./worker/index').Do>;
		DB: D1Database;
		ASSETS: Fetcher;
	}
}
